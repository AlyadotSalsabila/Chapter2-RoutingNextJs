...
export const blogPosts: BlogPost[] = [
    {
        ...
        date: "2024-03-15",
        excerpt: "Learn the basic of Next.js and start building your first app.",
        category: "nextjs",
        content: `
    ...
    },
    {
        ...
        category: "CSS",
        content: `CSS is gaining powers with recent web evolution. And it is very clever with tricks that were long existing or that
